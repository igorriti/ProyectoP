...
const items = [
    ...
    {   
        id: 4,
        name: 'El infiltrado',
        description: "Cada jugador debera sacar una carta y leerla en secreto. A algunos les tocara ser el infiltrado y a los demas una misma palabra. \n En ronda los jugadores deberan decir una palabra que se relacione con la que les toco. El infiltrado no la sabra pero debera hacer lo mismo,  sin que los demas se den cuenta que es el infiltrado. \n Al final de la ronda, los jugadores deberan votar quien creen que es el infiltrado. Si el infiltrado es descubierto, debera recibe 1 polaquito. Si no, los demas jugadores deberan recibir 1. Cantidad minima de jugadores: 3" ,
        icon: <GameIcons name="testicons-spy" size={50} color="#fff" />,
        screen: "Infiltrate"  
    },
    
    {   id: 5,
        name: 'Verdad o polaquito',
        description: "Los jugadores deberan sacar una carta y responder la pregunta que le toque. Si no quiere responder, debera recibir 1 polaquito. No seas salame y si una persona se siente incomoda, no la presiones y no arruines el ambiente." ,
    ...
    {   
        id: 6,
        name: 'Yo nunca nunca',
        description: "En este juego una persona debera sacar una carta y leer la consigna. Los que hayan hecho lo que dice la carta, reciben 1 polaquito.",
        icon: <GameIcons name="testicons-secret-book" size={50} color="#fff"/>,
        screen: "NeverMode"
    },
    {   id: 7,
        name: 'Carrera de caballos',
        description: "Te crees una persona con suerte? \nEn este juego integrado a tu Chromecast o Smart TV deberas apostar una cierta cantidad de polaquitos a un caballo. Si tu caballo gana, podras repartir los polaquitos que apostaste a los demas jugadores.\nPero ojo, para apostar polaquitos primero los tenes que tomar vos. Por ejemplo: Si quiero apostar 3 polaquitos, primero tengo que tomar 3 polaquitos. Cantidad minima de jugadores: 3",
    ...
    },
    {
        id: 8,
        name: 'Fulvo',
        description: "Saldra un escudo de un club argentino y deberas decir el nombre del club. Si no lo sabes, recibis 2 polaquitos.",
    ...
    },
    {
        id: 9,
        name: 'Mix',
        description: "En este juego se mezclan las cartas del modo clasico, el Aca se pudre, Verdad o polaquito y Yo nunca nunca \nDeberas sacar una carta y cumplir con la consigna que le o les toque.",
